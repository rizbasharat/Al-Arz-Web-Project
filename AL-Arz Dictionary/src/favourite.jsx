...
function App ()
{
  return (
    <section className="bg-hero-bg md:h-screen bg-cover bg-center font-Barlow pb-2">
      ...
      <div>
      <h2 style={{textAlign: "center"}} className="text-white w-full font-Bahnschrift pb-2 text-7xl "  >  پسندیدہ لفظ     </h2>
  ...
  <div style={{display:'flex',width:'100vw',justifyContent:'center'}}>
    ...
    <table style={{
        ...
        <tr style={{padding:'6vh',border:'1px solid white'}}>
            <td style={{border:'1px solid white',padding:'2rem'}}>kasjd</td>
            <td style={{border:'1px solid white',padding:'2rem'}}>kasjd</td>
        </tr>
        <tr style={{padding:'6vh',border:'1px solid white'}}>
                <td style={{border:'1px solid white',padding:'2rem'}}>kasjd</td>
